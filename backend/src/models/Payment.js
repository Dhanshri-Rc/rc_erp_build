...
const schema = new mongoose.Schema({
  ...
  vendor: { type: mongoose.Schema.Types.ObjectId, ref: 'Vendor', required: true }, amount: { type: Number, required: true, min: 0.01 }, currency: { type: String, enum: ['INR','USD'], default: 'INR' }, paymentMode: String, transactionId: String, transactionDate: Date, proof: String,
