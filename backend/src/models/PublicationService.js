...
const schema = new mongoose.Schema({
  ...
  currency: { type: String, default: 'INR' }, exchangeRate: { type: Number, default: 1 }, totalAmount: { type: Number, required: true }, advanceAmount: { type: Number, default: 0 }, remainingAmount: { type: Number, default: 0 },
